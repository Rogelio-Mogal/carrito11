                    ...
                    <tbody>
                        @foreach ($caracteristica as $item)
                            <tr>
                                ...
                                <td>
                                    @if ($item->activo == 1)
                                        <a href="{{ route('admin.producto.caracteristica.edit', $item->id) }}"
                                            data-id="{{ $item->id }}"
                                        ...
                                        <a href="{{ route('admin.producto.caracteristica.destroy', $item->id) }}"
...
@section('js')
    <script>
        ...
        $(document).ready(function() {
            var caracteristicaTable = new DataTable('#caracteristica', {
                responsive: true,
                "language": {
