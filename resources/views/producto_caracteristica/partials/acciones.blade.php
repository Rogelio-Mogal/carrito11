@if ($item->activo == 1)
    <a href="{{ route('admin.producto.caracteristica.edit', $item->id) }}" data-id="{{ $item->id }}"
    ...
    <a href="{{ route('admin.producto.caracteristica.destroy', $item->id) }}" data-popover-target="eliminar{{ $item->id }}"
