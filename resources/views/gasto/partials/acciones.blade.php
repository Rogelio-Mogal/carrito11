@if ($item->activo == 1)
    <a href="#" data-id="{{ $item->id }}" data-popover-target="editar{{ $item->id }}" data-popover-placement="bottom"
    ...
    <a href="{{ route('admin.gastos.destroy', $item->id) }}" data-popover-target="eliminar{{ $item->id }}"
...
@else
    <a href="{{ route('admin.gastos.edit', $item->id) }}" data-popover-target="activar{{ $item->id }}"
        data-popover-placement="bottom" data-id="{{ $item->id }}"
