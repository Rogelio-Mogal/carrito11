<!-- Main modal -->
<div id="anticipo-apartado-modal" tabindex="-1" aria-hidden="true"
    class="anticipo-apartado-modal hidden fixed inset-0 z-50 flex justify-center items-center w-full overflow-y-auto overflow-x-hidden bg-black bg-opacity-50">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 dark:bg-gray-800">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                    LISTADO DE ANTICIPOS - APARTADOS
                </h3>
                <button type="button"
                    ...
                    data-modal-hide="anticipo-apartado-modal">
            ...
            <div class="p-4 md:p-5 space-y-4 dark:bg-gray-800">
                <table id="tablaAnticipoApartado" class="table table-striped" style="width:100%">
                    <thead>
                        <tr>
                            <th>Seleccionar</th>
                            <th>Fecha</th>
