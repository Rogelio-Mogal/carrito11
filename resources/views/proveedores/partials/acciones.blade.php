@if ($item->activo == 1)
    <a href="{{ route('admin.proveedores.edit', $item->id) }}" data-id="{{ $item->id }}"
    ...
    <a href="{{ route('admin.proveedores.destroy', $item->id) }}" data-popover-target="eliminar{{ $item->id }}"
...
@else
    <a href="#" data-popover-target="activar{{ $item->id }}" data-popover-placement="bottom" data-id="{{ $item->id }}"
