    ...
    <div class="shadow-md rounded-lg p-4 dark:bg-gray-800">
        <div class="grid grid-cols-1 lg:grid-cols-12 md:grid-cols-12 sm:grid-cols-12 gap-4">
            <div class="sm:col-span-12 lg:col-span-12 md:col-span-12">
                <table id="sucursal" class="table table-striped" style="width:100%">
                    <thead>
                        <tr>
                        ...
                        @foreach ($sucursales as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endif
                                    @if( $item->es_matriz == 1 )
                                        <span class="bg-green-100 text-green-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">Si</span>
                                    @endif
                                </td>
                                <td>
                                    @if ($item->activo == 1)
...
@section('js')
    <script>
        ...
        $(document).ready(function() {
            var proveedorTable = new DataTable('#sucursal', {
                responsive: true,
                "language": {
            ...
            $('#sucursal').on('click', '.delete-item', function(e) {
                e.preventDefault();
                var id = $(this).data('id');
            ...
            $('#sucursal').on('click', '.activa-item', function(e) {
                e.preventDefault();
                var id = $(this).data('id');

                // Utilizar SweetAlert2 para mostrar un mensaje de confirmación
                Swal.fire({
                    title: 'La sucursal está deshabilitada',
                    text: '¿Está seguro de activar la sucursal?',
                    icon: 'info',
                    showCancelButton: true,
